...
This table lists the configuration variables required to operate Splunk Attack Analyzer Connector for Splunk SOAR. These variables are specified when configuring a Splunk Attack Analyzer asset in Splunk SOAR.
